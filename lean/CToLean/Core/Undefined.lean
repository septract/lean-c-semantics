...
/-- Alias for ub009_outsideLifetime -/
abbrev useAfterFree := ub009_outsideLifetime

/-- Alias for ub_cerb002c_outOfBoundFree -/
abbrev doubleFree := ub_cerb002c_outOfBoundFree

/-- Alias for ub046_arrayPointerOutside -/
abbrev outOfBounds := ub046_arrayPointerOutside

/-- Alias for ub043_indirectionInvalidValue -/
abbrev nullDeref := ub043_indirectionInvalidValue

/-- Alias for ub012_lvalueReadTrapRepresentation -/
abbrev uninitializedRead := ub012_lvalueReadTrapRepresentation

/-- Alias for ub025_misalignedPointerConversion -/
abbrev invalidAlignment := ub025_misalignedPointerConversion

/-- Alias for ub045a_divisionByZero -/
abbrev divisionByZero := ub045a_divisionByZero

/-- Alias for ub052b_nonRepresentableLeftShift -/
abbrev signedOverflow := ub052b_nonRepresentableLeftShift

/-- Alias for ub051b_shiftTooLarge -/
abbrev shiftOutOfRange := ub051b_shiftTooLarge

/-- Alias for ub046_arrayPointerOutside -/
abbrev invalidPointerArith := ub046_arrayPointerOutside

/-- Alias for ub053_distinctAggregateUnionPointerComparison -/
abbrev invalidPointerComparison := ub053_distinctAggregateUnionPointerComparison

/-- Alias for ub048_disjointArrayPointersSubtraction -/
abbrev invalidPointerSubtraction := ub048_disjointArrayPointersSubtraction

/-- Alias for ub037_illtypedLoad -/
abbrev invalidCast := ub037_illtypedLoad

/-- Alias for ub035_unsequencedRace -/
abbrev unsequencedModification := ub035_unsequencedRace

end UndefinedBehavior
